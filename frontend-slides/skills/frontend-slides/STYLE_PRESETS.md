...
> **IBM presentations**: Do not choose from this file. Read [IBM_BRAND_GUIDELINES.md](IBM_BRAND_GUIDELINES.md) instead — the IBM brand system is mandatory and fully specified there.

---

## IBM Developer Preset (Mandatory for IBM decks)

> ⚠ This preset is auto-applied whenever the IBM Brand Mode is triggered. It cannot be mixed with other presets.
> Full specification: [IBM_BRAND_GUIDELINES.md](IBM_BRAND_GUIDELINES.md)

**Vibe:** Professional, clean, authoritative — IBM corporate identity

**Theme Variants:** White (default), Cool Gray 10, Blue (cover/divider)

**Typography:**
- Display / Headings: `IBM Plex Sans` (700 Bold)
- Body / Subheads: `IBM Plex Sans` (400 Regular, 300 Light)
- Code: `IBM Plex Mono` (300 Light)

**Colors:**
```css
:root {
    /* IBM Developer 2021 — White Theme (default) */
    --slide-bg:       #FFFFFF;
    --slide-text:     #000000;
    --slide-muted:    #565656;
    --slide-accent:   #1261FD;   /* IBM Blue */
    --slide-border:   #C1C7CD;
    --ibm-pink:       #FF7EB5;
    --ibm-teal:       #3BDAD8;
...
/* Blue theme — cover + divider slides */
.slide.theme-blue {
    --slide-bg:    #1261FD;
    --slide-text:  #FFFFFF;
    background:    #1261FD;
...
- Hero title: 96px bold
- Slide title: 48px bold
- Section divider: 72px bold
- Body: 24–28px regular
- Caption: 18px light
- Footer: 12px light

**Signature Elements:**
- Flat white background (no gradients)
- IBM Blue (`#1261FD`) horizontal rule under titles
- Two-column content grid: left col (x=44, w=870), right col (x=1006, w=866)
- Footer bar (54px) every content slide: group name / doc ID / date / © IBM
- Cover slides: Blue background, white IBM Plex Sans Bold, no photos
- Accent highlights via IBM Pink, Teal, Purple, or Sky Blue for cards/badges
...
|--------|--------------|-----------|--------|
| **IBM Developer** | **IBM Plex Sans Bold** | **IBM Plex Sans** | **Google** |
